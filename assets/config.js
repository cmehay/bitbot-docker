...
config.exchangeSettings = {
	...
	currencyPair: {pair: '${PAIR}', asset: '${ASSET}', currency: '${CURRENCY}'},
...
//------------------------------APISettings
config.apiSettings = {
	bitstamp: {clientId: 0, apiKey: '${APIKEY}', secret: '${SECRET}'},
	kraken: {apiKey: '${APIKEY}', secret: '${SECRET}'},
	btce: {apiKey: '${APIKEY}', secret: '${SECRET}'}
};
//------------------------------APISettings

//------------------------------dbSettings
config.mongoConnectionString = '${MONGOSTRING}';
